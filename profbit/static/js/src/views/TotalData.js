                            ...
                            <div class="card-content black-text">
                              <div class="flow-text row no-margin">
                                ...
                                <div class="col s6 investment-container border-right">
                                  <InvestmentData value={currencyStats.return_investment} isReturnsData={true} />
                                </div>
                                <div class="col s6 investment-container">
                                  <InvestmentData value={currencyStats.return_percent} isPercent={true} isReturnsData={true} />
                                </div>
                              </div>
                            </div>
                          </div>
